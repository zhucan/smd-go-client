...
func (a *DisksApiService) GetDisk(ctx context.Context, diskId int64) (ModelsDisk, *http.Response, error) {
	var (
		...
		localVarReturnValue ModelsDisk
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/disks/{disk-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"disk-id"+"}", fmt.Sprintf("%v", diskId), -1)
