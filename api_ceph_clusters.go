...
@return ModelsCephCluster
*/
func (a *CephClustersApiService) DeleteCephCluster(ctx context.Context) (ModelsCephCluster, *http.Response, error) {
	var (
...
@return ModelsCephCluster
*/
func (a *CephClustersApiService) GetCephCluster(ctx context.Context) (ModelsCephCluster, *http.Response, error) {
	var (
