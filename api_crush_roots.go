...
*/
func (a *CrushRootsApiService) AddOsdsToCrushRoot(ctx context.Context, body RoutesCrushRootRequestParams, crushRootId int64) (ModelsCrushRoot, *http.Response, error) {
	var (
