...
/*
OsUserApiService create os user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

@return ModelsOsUser
*/
func (a *OsUserApiService) CreateOsUser(ctx context.Context, body RoutesCreateOsUserRequestParams) (ModelsOsUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ModelsOsUser
	)
...
/*
OsUserApiService delete os user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param osUserId identifier of the os user
...
func (a *OsUserApiService) DeleteOsUser(ctx context.Context, osUserId int64) (ModelsOsUser, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/os-users/{os-user-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"os-user-id"+"}", fmt.Sprintf("%v", osUserId), -1)
...
/*
OsUserApiService get an os user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param osUserId identifier of the os user
...
/*
OsUserApiService update os user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param osUserId identifier of the os user
 * @param body
...
@return ModelsOsUser
*/
func (a *OsUserApiService) UpdateOsUser(ctx context.Context, osUserId int64, body RoutesUpdateOsUserRequestParams) (ModelsOsUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
