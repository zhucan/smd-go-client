...
@return ModelsPool
*/
func (a *PoolsApiService) DeletePool(ctx context.Context, poolId int64) (ModelsPool, *http.Response, error) {
	var (
...
@return ModelsPool
*/
func (a *PoolsApiService) GetPool(ctx context.Context, poolId int64) (ModelsPool, *http.Response, error) {
	var (
